...
describe("O1 file preview", () => {
    ...
    it("renders html previews in a sandboxed iframe without scripts", () => {
        renderPreview({
            ...
            proxyUrl: "/api/file?id=result-1&path=%2Ftmp%2Fresults%2Freport.html",
        });
    ...
    it("shows a file too large message with download link on 413", () => {
        ...
        expect(
            screen.getByRole("link", { name: /download file/i }).getAttribute("href"),
    ...
    it("renders binary previews as metadata without a download button", () => {
        renderPreview({
            ...
            proxyUrl: "/api/file?id=result-1&path=%2Ftmp%2Fresults%2Fsample.bam",
        });
    ...
    it("shows the first 100 rows for csv previews with a row count summary", () => {
        renderPreview({
            ...
            proxyUrl: "/api/file?id=result-1&path=%2Ftmp%2Fresults%2Freport.csv",
        });
