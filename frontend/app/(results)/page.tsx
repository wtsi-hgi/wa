                ...
                <div className="grid gap-8 px-6 py-8 sm:px-8 lg:grid-cols-[1.25fr_0.95fr] lg:px-10 lg:py-10">
                    <div className="space-y-6">
                        <div className="space-y-3">
                            ...
                            <h1 className="max-w-3xl text-4xl font-semibold tracking-tight text-balance sm:text-5xl">
                                Registrations, pipeline flow, and search entry in one landing
                                view.
                            </h1>
                            <p className="max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                                Review the last 30 days at a glance, then pivot into recent
                                result sets or a targeted search without leaving the dashboard.
                            </p>
                        </div>
                    ...
                    <div className="relative overflow-hidden rounded-[1.75rem] border border-border/70 bg-background/80 p-5">
                        ...
                        <p className="mt-2 max-w-sm text-sm leading-6 text-muted-foreground">
                            The chart and cards below stay visible even during filtered views,
                            so search doesn&apos;t hide the broader system context.
                        </p>
